...
public class ThumbnailsAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "THUMBNAILS_ADAPTER";
    private static int lastPosition = -1;
    private ThumbnailCallback thumbnailCallback;
    private List<ThumbnailItem2> dataSet;

    public ThumbnailsAdapter2(List<ThumbnailItem2> dataSet, ThumbnailCallback thumbnailCallback) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        final ThumbnailItem2 thumbnailItem = dataSet.get(i);
